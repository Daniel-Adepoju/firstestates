      ...
      <div className="cardContainer">
        <div onClick={visitCard} className="card">
          ...
          <div className="body">
            ...
            <div className="w-full text-xl dark:text-gray-300 text-gray-500 font-bold p-2 pb-0 rounded-sm">{listing?.school}</div>
        ...
        items-center justify-start
         break-words otherCard rounded-2xl shadow-xs">
            ...
            <div className="tag"><Star size={20} color="#f59e0b"/></div>
