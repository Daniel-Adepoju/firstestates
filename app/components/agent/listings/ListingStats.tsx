  ...
  return (
    <div className="adminDashboard_content grid grid-cols-1 md:grid-cols-2 gap-4 dark:text-white self-center">
      <div className="content_item banner full font-head">
        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-200">Renting</h3>
        <div className="text">
      ...
      <div className="content_item banner full font-head">
        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-200">All Listings</h3>
        <div className="text">
