...
if(success) {
  return <div className="otherHead text-2xl font-bold mt-35 mx-auto">Password reset link sent to your email</div>
}
  return (
    <div className="max-w-md w-full mx-auto mt-20 mb-5 p-6 rounded-lg shadow-md bg-white dark:bg-darkGray dark:text-white">
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-4">
        <div>
          ...
          <div className="flex items-center border rounded-sm px-3 py-2 dark:border-gray-700 dark:bg-gray-600">
