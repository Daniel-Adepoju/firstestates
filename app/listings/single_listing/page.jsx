...
{/* Map Button */} 
  ...
  className="clickable directional smallScreen darkblueBtn openMap">
    <Image width={30} height={30} alt="mapBtn"
    src={'/icons/map.svg'} />
    <span>Open In Map</span>
  </Button>
    
 <div className="single_card smallScreen">
 <div className="price">
...
<div> Listed by <span>John Doe</span></div>
    ...
    <div className="largeScreenBtn">
    <Button
  functions={() => openInGoogleMap(address)}
  className="clickable directional largeScreen darkblueBtn openMap">
    <Image width={30} height={30} alt="mapBtn"
    src={'/icons/map.svg'} />
    <span>Open In Map</span>
  </Button>  
