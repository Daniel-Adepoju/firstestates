...
export const useGetSingleListing = (listingId: string | null, agent = false) => {
  const getListing = async () => {
    const url = agent ? `/api/listings/${listingId}?agent=${agent}` : `/api/listings/${listingId}`
...
// Agents
export const useGetAgentListings = ({
  id,
  page,
  limit,
  location,
...
export const useGetAgentListingsInfinite = ({
  id,
  page,
  limit,
  location,
...
export const useGetAgentPayments = ({
  userId,
  enabled,
}: {
  userId?: string
