...
export const verifyOTP = async({username,email,role,userPassword,phone,whatsapp,address,clientOtp}) => {
...
export const signInWithCredentials = async (email,password) => {
 ...
 if (res?.error) {
  ...
  return {message:'Invalid Email or Password',status:'warning'}
    ...
    return {message:'something went wrong, please try again', status:'danger'}
  }
} 
